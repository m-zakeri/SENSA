...
def name_recommendation(test_dataX, test_dataY, learned_dataX, learned_dataY, type):
    ...
    for recommended in recommended_names:
        ...
        if UseKNeighborsClassifier:
            ListResult.append(
                [ExpectedMethodID, ExpectedMethodName, RecommendedMethodName, classifier_pred, RecommendedMethodID,
                 WuPalmerScore, Precision, Recall, f1score])
        else:
            ListResult.append(
                [ExpectedMethodID, ExpectedMethodName, RecommendedMethodName, RecommendedMethodID, WuPalmerScore,
